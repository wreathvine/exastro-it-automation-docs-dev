...
-  パラメータシート定義/作成にて、作成対象「パラメータシート（ホスト/オペレーションあり）」が作成されている
...
#. | **パラメータシートの作成
     **\ [パラメータシート作成] -
     [パラメータシート定義/作成]画面からのパラメータシートを作成します。
   | 詳細は 「利用手順マニュアル_パラメータシート作成機能」を参照してください。
...
**図 6.1‑1比較対象パラメータシート（パラメータシート作成・定義）**
