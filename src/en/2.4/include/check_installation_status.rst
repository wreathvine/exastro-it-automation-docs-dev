| Input the following commands into the command line and check that the system has been installed.
...
.. code-block:: bash
    ...
    | If the system is running, check that ita-migration-xxx and platform-migration-xxx are“Completed”. All other should be“Running”.
    | ※The user might have to wait a little bit before the system is running.
