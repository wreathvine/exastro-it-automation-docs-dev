...
#. | 登録画面の項目一覧は以下のとおりです。
   ...
   .. table:: 登録画面項目一覧（対話ファイル素材集）
      ...
      +-----------------------------------+-------------------------------------------------------------------------------------+-----------+--------------+------------------------+
      | 対話種別名                        | :menuselection:`Ansible-Pioneer --> 対話種別` \                                     | ○         | リスト選択   | 説明欄記載のとおり。   |
      |                                   | で登録した :menuselection:`対話種別` が表示されます。                               |           |              |                        |
      |                                   |                                                                                     |           |              |                        |
      |                                   | 登録する対話ファイルの対話種別を選択します。                                        |           |              |                        |
      +-----------------------------------+-------------------------------------------------------------------------------------+-----------+--------------+------------------------+
      | OS種別                            | :menuselection:`Ansible-Pioneer --> OS種別` で登録した :menuselection:`OS種別` \    | ○         | リスト選択   | 説明欄記載のとおり。   |
      |                                   | が表示されます。                                                                    |           |              |                        |
      |                                   |                                                                                     |           |              |                        |
      |                                   | 登録する対話ファイルのOS種別を選択します。                                          |           |              |                        |
      +-----------------------------------+-------------------------------------------------------------------------------------+-----------+--------------+------------------------+
      | 対話ファイル素材                  | :menuselection:`対話種別` と :menuselection:`OS種別` に対応する対話ファイルを\      | ○         | ファイル選択 | 最大サイズ100Mバイト   |
      |                                   | アップロードします。                                                                |           |              |                        |
      |                                   |                                                                                     |           |              |                        |
